...
public class Model extends Observable {
                ...
                if(t!=null) {
                    ...
                    int nc=c;
                        ...
                        while(nr<=3) {
                            ...
                            //if it is not null-> merge or stay
                            if(nt != null) {
                                // stay in current position -- r
    ...
    public static boolean atLeastOneMoveExists(Board b) {
        // TODO: Fill in this function.
        if (emptySpaceExists(b) || hasSameValue(b)) {
            return true;
        }
        return false;
    }

    public static boolean hasSameValue(Board b) {
        int[][] move = { { -1, 0 }, { 0, -1 }, { 1, 0 }, { 0, 1 } };// 上左下右
        for (Tile t : b) {
            for (int i = 0; i < 4; i++) {
